...
module Coq_sforces_cbn : 
 ...
 sig 
  ...
  val coq_Kont_sforces_mon2' :
    ...
    -> sforces Coq_ks_monad.coq_Kont -> bool -> sforces Coq_ks_monad.coq_Kont
 ...
 sig 
  ...
  module Coq_generic_properties : 
   sig 
    ...
    val ret :
      Coq_ks.coq_K -> bool -> formula -> Coq_cbn_validity.sforces ->
      Coq_cbn_validity.sforces Coq_cbn_validity.Coq_ks_monad.coq_Kont
    
    val bind :
      Coq_ks.coq_K -> bool -> formula -> formula -> (Coq_ks.coq_K ->
      Coq_ks.wle -> Coq_cbn_validity.sforces -> Coq_cbn_validity.sforces
      Coq_cbn_validity.Coq_ks_monad.coq_Kont) -> Coq_cbn_validity.sforces
      Coq_cbn_validity.Coq_ks_monad.coq_Kont -> Coq_cbn_validity.sforces
 ...
 sig 
  ...
  module Coq_cbn_validity : 
   sig 
    ...
    val coq_Kont_sforces_mon2' :
      context -> bool -> formula -> (context -> sforces -> sforces) ->
      sforces Coq_ks_monad.coq_Kont -> bool -> sforces Coq_ks_monad.coq_Kont
  ...
  module Coq_generic_properties : 
   sig 
    ...
    val ret :
      context -> bool -> formula -> Coq_cbn_validity.sforces ->
      Coq_cbn_validity.sforces Coq_cbn_validity.Coq_ks_monad.coq_Kont
    
    val bind :
      context -> bool -> formula -> formula -> (context -> U.wle ->
      Coq_cbn_validity.sforces -> Coq_cbn_validity.sforces
      Coq_cbn_validity.Coq_ks_monad.coq_Kont) -> Coq_cbn_validity.sforces
      Coq_cbn_validity.Coq_ks_monad.coq_Kont -> Coq_cbn_validity.sforces
      Coq_cbn_validity.Coq_ks_monad.coq_Kont
